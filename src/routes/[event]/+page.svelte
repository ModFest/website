...
<div class="card" style="background-color: {event.background_color}">
    <img
            class="cover-image"
...
{#if !event.submissions_open}
    <div class="center card-spacing">
        {#if event.id==='1.20'}
        <a href="https://modrinth.com/modpack/modfest-1.20" target="_blank" class="button clickable">Play!</a>
        <a href="https://forms.gle/aoJt8H8drQWNGoS48" target="_blank" class="button clickable">Vote!</a>
        {/if}
...
{#if event.id === 'singularity'}
    ...
    <div class="card">
        <h1>Theme</h1>
        <p>
            For ModFest: Singularity, your mod <b>must</b> only have ONE feature. Focus all of your effort throughout
...
{:else if event.id === '1.20'}
    ...
    <div class="card">
        ...
        {:else}
            <p>To check it out, install the <a href="https://modrinth.com/project/modfest-1.20" target="_blank">ModFest
                ...
                Multiplayer list.</p>
            <p>Check out the booths, and make sure to <a href="https://forms.gle/aoJt8H8drQWNGoS48" target="_blank">vote for the mods that best fit each category!</a></p>
        {/if}
    </div>
    <div class="card">
        <h1>Theme</h1>
    ...
    <div class="card">
        ...
        <ul>
            <li>
                Mods must be compatible with the <a href="https://fabricmc.net/" target="_blank">Fabric</a> mod loader
